...
$(UNIT_TEST_OBJ_DIR)/%.o: $(UNIT_TEST_DIR)/%.cpp
	$(CXX) $(CPPFLAGS_TEST) $(CXXFLAGS) -c $< -o $@

$(INTEGRATION_TEST_OBJ_DIR)/%.o: $(INTEGRATION_TEST_DIR)/%.cpp
	$(CXX) $(CPPFLAGS_TEST) $(CXXFLAGS) -c $< -o $@

$(OBJ_DIR) $(UNIT_TEST_OBJ_DIR) $(INTEGRATION_TEST_OBJ_DIR) $(OBJ_DIR)/main:
	mkdir -p $@
